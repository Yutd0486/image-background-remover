      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">BG Remover</h1>
            <p className="text-gray-600 mt-2">Remove image backgrounds instantly</p>
          </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            Sign in to remove image backgrounds
          </p>
        </div>
      </div>
    </div>
